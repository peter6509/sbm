/*
 *所有关于Sys_NotificationTemplate類的業務代碼應在此處编写
...
*Sys_NotificationTemplateService對增、删、改查、导入、导出、審核業務代碼扩展参照ServiceFunFilter
*/
...
namespace VolPro.Sys.Services
{
    public partial class Sys_NotificationTemplateService
    {
        ...
        private readonly ISys_NotificationTemplateRepository _repository;//訪問數據庫
