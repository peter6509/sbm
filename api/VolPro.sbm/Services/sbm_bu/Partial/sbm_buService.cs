...
*sbm_buService對增、删、改查、导入、导出、審核業務代碼扩展参照ServiceFunFilter
*/
...
{
    public partial class sbm_buService
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly Isbm_buRepository _repository;//訪問數據庫

        [ActivatorUtilitiesConstructor]
        public sbm_buService(
            Isbm_buRepository dbRepository,
