...
*sbm_testService對增、删、改查、导入、导出、審核業務代碼扩展参照ServiceFunFilter
*/
...
{
    public partial class sbm_testService
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly Isbm_testRepository _repository;//訪問數據庫

        [ActivatorUtilitiesConstructor]
        public sbm_testService(
            Isbm_testRepository dbRepository,
