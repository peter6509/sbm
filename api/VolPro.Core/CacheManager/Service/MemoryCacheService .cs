...
namespace VolPro.Core.CacheManager
{
    public class MemoryCacheService : ICacheService
    {
        ...
        /// <param name="key">缓存Key</param>
        /// <param name="value">缓存Value</param>
        /// <param name="expiresSliding">滑動過期時长（如果在過期時间内有操作，则以當前時间點延长過期時间）</param>
        /// <param name="expiressAbsoulte">绝對過期時长</param>
        /// <returns></returns>
        ...
        /// <param name="key">缓存Key</param>
        /// <param name="value">缓存Value</param>
        /// <param name="expiresIn">缓存時长</param>
        /// <param name="isSliding">是否滑動過期（如果在過期時间内有操作，则以當前時间點延长過期時间）</param>
        /// <returns></returns>
