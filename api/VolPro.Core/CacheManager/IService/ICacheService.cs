...
namespace VolPro.Core.CacheManager
{
    public interface ICacheService : IDisposable
    {
        ...
        /// <summary>
        /// 移除list中的數據，keepIndex為保留的位置到最后一個元素如list 元素為1.2.3.....100
        /// 需要移除前3個數，keepindex應该為4
        /// </summary>
        /// <param name="key"></param>
        ...
        /// <param name="isSliding">是否滑動過期（如果在過期時间内有操作，则以當前時间點延长過期時间） //new TimeSpan(0, 60, 0);</param>
        /// <returns></returns>
