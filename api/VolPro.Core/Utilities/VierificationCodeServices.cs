...
namespace VolPro.Core.Utilities
{
    ...
    {   
        ...
        public static string CreateBase64Image(string code)
        {
            ...
            {
                pen.Color = random.GetRandom(colors);//随機颜色索引值

                pen.Typeface = SKTypeface.FromFamilyName("DejaVu Sans", 700, 20, SKFontStyleSlant.Italic);//配置字體
                ...
                canvas.DrawText(code.Substring(i, 1), point, pen);//绘制一個驗証字符
