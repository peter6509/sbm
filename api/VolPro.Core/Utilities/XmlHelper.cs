...
/// 這個是用VS2010写的，如果用VS2005，請去掉System.Linq和System.Xml.Linq的引用
/// 可以將此文件直接编译成dll，今后程序只需要引用该dll后開頭添加using XmlLibrary;即可。
namespace Rattan.Basic.Utility
{
	...
	public class XMLHelper
	{
		...
		/// <param name="parentNode">父节點</param>
		/// <param name="xlParameter">Xml参數</param>
		...
		/// <summary>
		/// 創建一個XML文档，成功創建后操作路径將直接指向该文件
		/// </summary>
		/// <param name="fileName">文件物理路径名</param>
		/// <param name="rootNode">根结點名稱</param>
		/// <param name="elementName">元素节點名稱</param>
		/// <param name="xmlParameter">XML参數</param>
		...
		/// 添加新节點
		/// </summary>
		/// <param name="parentNode">新节點的父节點對象</param>
		/// <param name="xmlParameter">Xml参數對象</param>
		...
		/// </summary>
		/// <param name="xDoc">XmlDocument對象</param>
		/// <param name="parentName">新节點的父节點名稱</param>
		/// <param name="xmlParameter">XML参數對象</param>
		...
		/// 添加节點屬性
		/// </summary>
		/// <param name="node">节點對象</param>
		/// <param name="namespaceOfPrefix">该节點的命名空间URI</param>
		...
		/// <param name="node">节點對象</param>
		/// <param name="namespaceOfPrefix">该节點的命名空间URI</param>
		/// <param name="attributeParameters">节點屬性参數</param>
		...
		/// 添加节點屬性
		/// </summary>
		/// <param name="nodeName">节點名稱</param>
		/// <param name="namespaceOfPrefix">该节點的命名空间URI</param>
		/// <param name="attributeName">新屬性名稱</param>
		/// <param name="attributeValue">屬性值</param>
		...
		public static XmlNode GetNode(string nodeName)
		{
			...
			XmlNodeList nlst = xDoc.DocumentElement.ChildNodes;
			foreach (XmlNode xns in nlst)  // 遍历所有子节點
			{
				if (xns.Name == nodeName) return xns;
				else
				{
					XmlNode xn = GetNode(xns, nodeName);
					if (xn != null) return xn;  /// V1.0.0.3添加节點判断
				}
			}
			return null;
		}
		...
		/// <param name="node">节點對象</param>
		/// <param name="nodeName">节點名稱</param>
		/// <param name="innerText">节點内容</param>
		...
		/// 删除节點
		/// </summary>
		/// <param name="nodeList">需要删除的节點對象</param>
		...
		/// <param name="xDoc">XmlDocument對象</param>
		/// <param name="nodeName">节點名稱</param>
		/// <param name="nodeText">节點内容</param>
		...
		/// </summary>
		/// <param name="xmlParameter">XML参數</param>
		/// <param name="attributeParameters">屬性参數</param>
