...
//        /// <param name="strHeaderText">表頭文本 空值未不要表頭標题</param>
//        /// <returns></returns>
...
//        /// <param name="strHeaderText">表頭文本 空值未不要表頭標题(多個表對應多個表頭以英文逗號(,)分開，個數應與表相同)</param>
//        /// <returns></returns>
...
//                            headerRow.GetCell(column.Ordinal).CellStyle = headStyle;
//                            //設置列宽
//                            // sheet.SetColumnWidth(column.Ordinal, (arrColWidth[column.Ordinal] + 1) * 256); // 設置設置列宽 太长會報错 修改2014 年9月22日
