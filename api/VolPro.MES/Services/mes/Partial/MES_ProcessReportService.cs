/*
 *所有关于MES_ProcessReport類的業務代碼應在此處编写
...
*MES_ProcessReportService對增、删、改查、导入、导出、審核業務代碼扩展参照ServiceFunFilter
*/
...
namespace VolPro.MES.Services
{
    public partial class MES_ProcessReportService
    {
        ...
        private readonly IMES_ProcessReportRepository _repository;//訪問數據庫
