/*
 *所有关于MES_ProductOutbound類的業務代碼應在此處编写
...
*MES_ProductOutboundService對增、删、改查、导入、导出、審核業務代碼扩展参照ServiceFunFilter
*/
...
namespace VolPro.MES.Services
{
    public partial class MES_ProductOutboundService
    {
        ...
        private readonly IMES_ProductOutboundRepository _repository;//訪問數據庫
