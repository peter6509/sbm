/*
 *所有关于MES_Bom_Detail類的業務代碼應在此處编写
...
*MES_Bom_DetailService對增、删、改查、导入、导出、審核業務代碼扩展参照ServiceFunFilter
*/
...
namespace VolPro.MES.Services
{
    public partial class MES_Bom_DetailService
    {
        ...
        private readonly IMES_Bom_DetailRepository _repository;//訪問數據庫
