...
<template>
	<vol-view ref="viewRef" :table="table" :columns="columns" :table-data="tableData"
		...
		<!--表格配置 -->
		<vol-alert>生成頁面顯示合計信息</vol-alert>
		<view class="summary">
			<text class="txt">總價格：</text><text class="vol-tag vol-tag-primary">{{summary.TotalPrice}}元</text>
			<text class="txt">總數量：</text><text class="vol-tag vol-tag-error">{{summary.TotalQty}}箱</text>
		</view>
