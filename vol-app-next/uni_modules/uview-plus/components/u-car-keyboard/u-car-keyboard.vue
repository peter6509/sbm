...
<script>
	...
	/**
	 * keyboard 鍵盘组件
	 * @description 此為uview-plus自定義的鍵盘面板，内含了數字鍵盘，车牌號鍵，身份证號鍵盘3种模式，都有可以打乱按鍵顺序的選項。
	 * @tutorial https://uview-plus.jiangruyi.com/components/keyboard.html
	 * @property {Boolean} random 是否打乱鍵盘的顺序
	...
	export default {
		...
		data() {
			return {
				// 车牌輸入時，abc=true為輸入车牌號碼，bac=false為輸入省份中文簡稱
				abc: false
			};
		},
		computed: {
