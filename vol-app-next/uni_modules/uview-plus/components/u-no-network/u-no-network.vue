<template>
	...
	>
		...
		>
			...
			<!-- 只有APP平台，才能跳轉設置頁，因為需要調用plus环境 -->
			<!-- #ifdef APP-PLUS -->
			<view class="u-no-network__app">
				<text class="u-no-network__app__setting">請檢查网络，或前往</text>
				<text
...
<script>
	...
	/**
	 * noNetwork 無网络提示
	 * @description 該组件無需任何配置，引入即可，内部自動處理所有功能和事件。
	 * @tutorial https://ijry.github.io/uview-plus/components/noNetwork.html
	 * @property {String}			tips 	没有网络時的提示語 （默認：'哎呀，网络信號丢失' ）
	 * @property {String | Number}	zIndex	组件的z-index值 
	 * @property {String}			image	無网络的圖片提示，可用的src地址或base64圖片 
	 * @event {Function}			retry	用户點擊頁面的"重试"按鈕時触發
