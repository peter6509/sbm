...
export const props = defineMixin({
    props: {
        ...
        // 主題类型，error|warning|success|primary
        type: {
            type: String,
        ...
        // 徽標形状，circle-四角均為圆角，horn-左下角為直角
        shape: {
            type: String,
            default: () => defProps.badge.shape
        },
        // 設置數字的显示方式，overflow|ellipsis|limit
        // overflow会根据max字段判断，超出显示`${max}+`
        // ellipsis会根据max判断，超出显示`${max}...`
        // limit会依据1000作為判断条件，超出1000，显示`${value/1000}K`，比如2.2k、3.34w，最多保留2位小數
        numberType: {
            type: String,
            default: () => defProps.badge.numberType
        },
        // 設置badge的位置偏移，格式為 [x, y]，也即設置的為top和right的值，absolute為true时有效
        offset: {
            type: Array,
