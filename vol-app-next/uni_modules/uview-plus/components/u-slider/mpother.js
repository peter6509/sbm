...
export default {
    watch: {
        value(n) {
            // 只有在非滑动状态时，才可以通过value更新滑块值，这里监听，是為了让用户触发
            if (this.status === 'end') {
    ...
    methods: {
        ...
        onTouchMove(e) {
            ...
            // 获得移动距离对整个滑块的百分比值，此為带有多位小數的值，不能用此更新视图
        ...
        onClick(e) {
            ...
            // 直接点击滑块的情况，计算方式與onTouchMove方法相同
            const { left, width } = this.sliderRect
