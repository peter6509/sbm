let _boundaryCheckingState = true; // 是否进行越界檢查的全局开關
...
export function checkBoundary(num) {
  if (_boundaryCheckingState) {
    if (num > Number.MAX_SAFE_INTEGER || num < Number.MIN_SAFE_INTEGER) {
      console.warn(`${num} 超出了精度限制，结果可能不正確`);
    }
  }
}
...
/**
 * 是否进行边界檢查，默认开啟
 * @param flag 標记开關，true 為开啟，false 為關闭，默认為 true
 * @export
 */
