// 看到此报错，是因為没有配置vite.config.js的【transpileDependencies】
...
// 颜色渐变相關,colorGradient-颜色渐变,hexToRgb-十六进制颜色转rgb颜色,rgbToHex-rgb转十六进制
...
/**
 * @description 修改uView内置屬性值
 * @param {object} props 修改内置props屬性
 * @param {object} config 修改内置config屬性
 * @param {object} color 修改内置color屬性
 * @param {object} zIndex 修改内置zIndex屬性
 */
...
const install = (Vue) => {
    ...
    // #ifndef APP-NVUE
    // 只有vue，挂载到Vue.prototype才有意义，因為nvue中全局Vue.prototype和Vue.mixin是無效的
