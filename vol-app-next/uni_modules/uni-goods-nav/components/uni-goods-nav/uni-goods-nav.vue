...
<script>
	 ...
	 * @property {Array} options 组件参數
	 * @property {Array} buttonGroup 组件按鈕组参數
	 * @property {Boolean} fill = [true | false] 组件按鈕组参數
	 * @property {Boolean} stat 是否開啟统計功能
	 * @event {Function} click 左侧點擊事件
	 * @event {Function} buttonClick 右侧按鈕组點擊事件
