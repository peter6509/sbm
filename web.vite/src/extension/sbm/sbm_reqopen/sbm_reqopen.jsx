...
*****************************************************************************************/
//此js文件是用来自定義扩展業務代碼，在當前[表.vue]文件中也可以實现業務处理
...
let extension = {
  ...
  tableAction: '', //指定某张表的權限(這里填写表名,默認不用填写)
  ...
  methods: {
    ...
    searchAfter(result) {
      //查詢后，result返回的查詢數據,可以在顯示到表格前处理表格的值
      return true;
    },
    addBefore(formData) {
    ...
    modelOpenAfter(row) {
      //點击编輯、新建按钮弹出框后，可以在此处写邏輯，如，从后台获取數據
