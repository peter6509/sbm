 ...
 *業務請在@/extension/system/Sys_Log.js此處編寫
 -->
<template>
  <view-grid
    ref="grid"
...
const searchFormOptions = ref([
  [
    { title: "請求地址", field: "Url", type: "text" },
    { title: "用户IP", field: "UserIP", type: "text" },
    { title: "服務器IP", field: "ServiceIP", type: "text" },
  ],
  [
    { title: "開始時間", field: "BeginDate", type: "datetime" },
    {
      dataKey: "restatus",
      data: [],
      title: "响應狀態",
...
const columns = ref([
  ...
  { field: "UserName", title: "用户名稱", type: "string", width: 90, align: "left" },
