...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const editFormOptions = ref([[{"title":"集团名稱","required":true,"field":"GroupName"}],
            ...
            const columns = ref([{field:'GroupId',title:'GroupId',type:'guid',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       {field:'GroupName',title:'集团名稱',type:'string',link:true,width:150,require:true,align:'left',sort:true},
