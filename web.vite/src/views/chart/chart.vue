        ...
        <div class="home-left">
          <div>
            <el-alert
              ...
              class="alert-primary"
              :closable="false"
              title="框架前端及文檔重構版本發布,兼容原有版本代碼及jsx寫法,放開自定義擴展组件限制,新版可任意選擇vue2/3/typescript語法開發方式"
            ></el-alert>
          </div>
          <div class="home-list">
...
const msg = ref([
  { name: '健身房突然倒閉，會员们的钱该如何追回？' },
  { name: '智能家电频繁死機，技術瓶颈待突破？' },
  { name: '热門综艺抄袭争议不断，原創之路在何方？' },
  { name: '宠物食品质量堪忧，毛孩子的健康谁守护？' },
  { name: '航空公司超售機票，乘客權益如何保障？' },
  { name: '服装快時尚品牌的環保 “谎言” 被戳破？' },
  { name: '共享充电宝收费乱象，為何屡禁不止？' },
  { name: '新兴职業高薪背后，隐藏着哪些挑战？' },
  { name: '酒店卫生乱象又現，出門住宿该如何選？' },
  { name: '美妆博主推荐产品翻车，信任危機爆發？' },
  { name: '热門景點游客過度拥挤，管理困境如何解？' }
])
