 ...
 *業務請在@/extension/sbm/sbm_reqopen/sbm_reqopen.jsx或sbm_reqopen.vue文件编写
...
<script setup lang="jsx">
    import extend from "@/extension/sbm/sbm_reqopen/sbm_reqopen.jsx";
    import viewOptions from './sbm_reqopen/options.js'
