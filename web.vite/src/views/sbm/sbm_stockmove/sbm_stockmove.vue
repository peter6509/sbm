 ...
 *業務請在@/extension/sbm/sbm_stockmove/sbm_stockmove.jsx或sbm_stockmove.vue文件编写
...
<script setup lang="jsx">
    import extend from "@/extension/sbm/sbm_stockmove/sbm_stockmove.jsx";
    import viewOptions from './sbm_stockmove/options.js'
