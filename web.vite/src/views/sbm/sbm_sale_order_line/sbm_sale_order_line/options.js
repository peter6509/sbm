...
export default function(){
    ...
    const key = table.key;
    const editFormFields = {"sale_item":"","prod_name":"","prod_num":"","prod_uom":"","price_unit":"","price_sub":"","prod_desc":""};
    const editFormOptions = [[{"title":"項次","field":"sale_item","colSize":9.999},
                               {"title":"產品","field":"prod_name","colSize":50.0},
                              ...
                              [{"title":"小計","field":"price_sub","colSize":11.111,"type":"decimal"},
                               {"title":"備註","field":"prod_desc","colSize":30.0}]];
    ...
    const columns = [{field:'id',title:'ID',type:'int',width:110,hidden:true,require:true,align:'left'},
                       ...
                       {field:'sale_item',title:'項次',type:'string',link:true,sort:true,width:50,edit:{type:''},align:'left'},
